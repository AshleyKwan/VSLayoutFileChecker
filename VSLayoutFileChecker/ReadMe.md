...
Args:
	...
	--notdownload : Auto skip download missing file. Conflict with --download option.
	...
	--skipLayoutParams: Skip the Layout Params run.

Note:
Visual Studio 2017 havn't offical --verify args for layout, so this utility is used to check the layout files. It tested for Visual Studio 2017, 2019 and 2022 (up to 17.13.0).
	...
	Since some layout params requested operation requires elevated privileges. if yes, the params may be run failed.
